        ...
        <div className='m-10'>
          <h1 className='text-5xl border-b p-3 font-bold'> Why Adopt from PawMart?</h1>
              <div className='flex justify-around m-10 items-center'>
                ...
                <div>
                   <h1 className='text-4xl m-3 text-shadow-fuchsia-300'>Support & Guidance</h1>
            ...
            <div className='flex justify-around m-10 items-center bg-cyan-200 p-5'>
                <div className=''>
                    <h1 className='text-4xl m-3 text-shadow-fuchsia-300'>Healthy & Vaccinated Pets</h1>
             ...
             <div className='flex justify-around m-10 items-center'>
                ...
                <div>
                   <h1 className='text-4xl m-3 text-shadow-fuchsia-300'>Affordable & Hassle-Free</h1>
